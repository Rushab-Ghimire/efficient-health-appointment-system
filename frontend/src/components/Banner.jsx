...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gradient-to-r from-cyan-200 via-blue-200 to-blue-200 rounded-3xl px-6 sm:px-10 md:px-14 lg:px-16 my-20 mx-4 md:mx-10 shadow-xl overflow-hidden">
