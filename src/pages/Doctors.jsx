      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className='flex flex-col gap-4 text-sm text-gray-600 w-full sm:w-60'>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'General physician' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            General physician
          </p>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'Gynecologist' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            Gynecologist
          </p>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'Dermatologist' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            Dermatologist
          </p>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'Pediatricians' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            Pediatricians
          </p>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'Neurologist' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            Neurologist
          </p>
          <p
            ...
            className={`pl-4 py-2 pr-4 border border-gray-300 rounded-md transition-all cursor-pointer hover:bg-indigo-50 ${
              speciality === 'Gastroenterologist' ? 'bg-indigo-100 text-black font-medium' : ''
            }`}
          >
            Gastroenterologist
          </p>
